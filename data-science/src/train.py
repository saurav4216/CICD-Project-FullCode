...
def main(args):
    ...
    mlflow.log_param("model", "used cars training model")  # Provide the model name
    ...
    mse = mean_squared_error(y_test, yhat_test)    # Compute and log mean squared error for test data
